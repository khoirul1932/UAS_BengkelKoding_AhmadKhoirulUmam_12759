...
<form style="Margin: 20px;" class="form row" method="POST" action="" name="myForm" onsubmit="return(validate());">
        ...
        <div class="col">
            ...
            <select style="margin: 5px;" name="id_pasien" id="id">
        ...
        <div class="col">
            ...
            <select style="margin: 5px;" name="id_dokter" id="id">
                <option  disabled selected> Pilih </option>
                <?php 
                $ambil = mysqli_query($mysqli, 
                "SELECT * FROM dokter");
        ...
        <div class="col">
            ...
            <select style="margin: 5px;" name="id" id="id">
                <option disabled selected> Pilih </option>
                <?php 
                $ambil = mysqli_query($mysqli, 
                "SELECT * FROM obat");
                while ($data = mysqli_fetch_array($ambil)) {
                ?>
                <option class="form-control" value="<?=$data['nama_obat']?>"><?=$data['nama_obat']?></option> 
                <?php
                }
                ?>
            </select>
